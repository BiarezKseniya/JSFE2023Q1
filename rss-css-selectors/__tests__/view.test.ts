...
test('should return attribute string for an element', () => {
  ...
  const element1 = document.createElement('div') as HTMLElement;
  element1.setAttribute('id', 'myId');
  element1.setAttribute('class', 'myClass');

  const element2 = document.createElement('plate') as HTMLElement;
  ...
  expect(result1).toBe(" <span class=\"attribute-name\">id</span><span class='attribute-assignment'>=</span><span class=\"attribute-value\">\"myId\"</span> <span class=\"attribute-name\">class</span><span class='attribute-assignment'>=</span><span class=\"attribute-value\">\"myClass\"</span>");
  expect(result2).toBe(" <span class=\"attribute-name\">class</span><span class='attribute-assignment'>=</span><span class=\"attribute-value\">\"alsoMyClass\"</span>");
